                ...
                <section className="pb-20">
                    <div className="container">
                        <div className="max-w-2xl lg:max-w-3xl mx-auto">
                            ...
                            {/* 下面保持你原结构（不再重复改动） */}
                            {/* ——如果你也要把 Contact 区改成统一的英文/中文版规范，我可以再继续给你两套 */}
                                ...
                                <form>
                                    ...
                                    <div className="flex flex-wrap mb-4 -mx-3 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                        <div className="w-full lg:w-1/2 px-3 mb-4 lg:mb-0">
                                            <div className="mb-4">
                                                <input className="w-full p-4 text-xs font-semibold leading-none bg-blueGray-50 rounded outline-none" type="text" placeholder="Role" />
                                            </div>
                                            <div className="mb-4">
