  ...
  return (
    <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
      ...
      <div className="product-card bg-white rounded-3xl border-2 h-full text-center transition-all duration-300 hover:-translate-y-2 shadow-sm" style={{ borderColor: `${accentColor}40`, background: bgGradient, paddingTop: 0, paddingLeft: 20, paddingRight: 20, paddingBottom: 20 }}>
        <div className="service-card-logo-wrap mb-5 flex justify-center items-center" style={{ height: "216px", minHeight: "216px" }}>
    ...
    <Layout>
      ...
      <section className="py-16 bg-white relative z-10">
        <div className="container px-4 mx-auto">
          ...
          <div id="services-cta" className="max-w-6xl mx-auto text-center mt-12 px-6 pt-16 pb-12 rounded-3xl border border-blueGray-100 bg-blueGray-50/50 scroll-mt-24" style={{ scrollMarginTop: '96px' }}>
