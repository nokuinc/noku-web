            ...
            <div className="flex flex-wrap items-stretch -mx-3 text-center">
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 flex flex-col items-stretch">
                <a href="https://wexun.com" target="_blank" rel="noopener noreferrer"
                  ...
                  <h3 className="mb-2 font-bold font-heading text-2xl brand-wexun">WeXun</h3>
                  ...
                  <div className="text-sm text-blueGray-400 leading-relaxed text-left min-h-[6rem] flex-1">
                    <p className="mb-2"><strong>Domain:</strong> Hiring · Work · Orders</p>
                    <p>Capturing real fulfillment and delivery as long-term verifiable professional facts.</p>
                  </div>
                </a>
              </div>
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 flex flex-col items-stretch">
                <a href="https://yuobo.com" target="_blank" rel="noopener noreferrer"
                  ...
                  <h3 className="mb-2 font-bold font-heading text-2xl brand-yuobo">YuoBo</h3>
                  <p className="text-sm font-bold text-brand mb-4 uppercase tracking-widest">
                    Live: Transactions / Collaboration
                  </p>
                  <div className="text-sm text-blueGray-400 leading-relaxed text-left min-h-[6rem] flex-1">
                    <p className="mb-2"><strong>Domain:</strong> Marketplace · Collaboration · Local Services</p>
                    <p>Records transaction and collaboration outcomes in marketplace activities.</p>
                  </div>
                </a>
              </div>
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 flex flex-col items-stretch">
                ...
                >
                  ...
                  <div className="text-sm text-blueGray-400 leading-relaxed text-left min-h-[6rem] flex-1">
                    <p className="mb-2">
                      <strong>Core Role:</strong> Long-term recording after completion
                    </p>
                    <p>
                      No scoring, no judgment — only transforming completed outcomes into verifiable, authorized, and revocable proofs.
                    </p>
                  </div>
                </a>
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start p-4 bg-blue-50 rounded-xl border-l-4 border-blue-500">
                      ...
                      <p className="text-blueGray-700 font-semibold ml-2">
                        <strong>On <span className="brand-wexun">WeXun</span>:</strong> Complete jobs and orders to
                    ...
                    <div className="flex items-start p-4 bg-blue-50 rounded-xl border-l-4 border-blue-500">
                      ...
                      <p className="text-blueGray-700 font-semibold ml-2">
                        <strong>On <span className="brand-yuobo">YuoBo</span>:</strong> Complete transactions and
                    ...
                    <div className="flex items-start p-4 bg-blue-50 rounded-xl border-l-4 border-blue-500">
                      ...
                      <p className="text-blueGray-700 font-semibold ml-2">
                        <strong>On <span className="brand-pledgedoc-gold">PledgeDoc</span>:</strong> Record and attest only
          ...
          <div className="container px-4 mx-auto text-center">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg mb-6 leading-loose text-blueGray-600 wow animate__animated animate__fadeIn">
                NoKu is a technology company focused on building infrastructure for factual recording and verification.<br />nokuinc.com is the sole global official website of Noku LLC.
              </p>
            </div>
