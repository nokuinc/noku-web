        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="max-w-6xl mx-auto text-center mt-20 px-6 py-12 rounded-3xl border border-blueGray-100 bg-blueGray-50/50">
            <div className="text-blueGray-800 leading-loose font-medium text-lg md:text-xl">
              ...
              <p>
                NoKu provides platform-level infrastructure that enables different systems and services to record, verify, and reuse real behavioral outcomes.<br />nokuinc.com is the sole global official website of NOKU LLC.
              </p>
            </div>
          </div>
        </div>
